...
class DataTrainingArguments:
    ...
    hf_token: Optional[str] = field(
        ...
        metadata={"help": "get your access token from huggingface."}
    )
    num_process: Optional[int] = field(
        default=1,
        metadata={"help": "Specify how many gpus you are you using."}
    )    
...
def main(model_args, data_args, training_args):
    ...
    login(token=data_args.hf_token)
    ...
    config['num_processes'] = data_args.num_process
